"""
Full Dataset Multi-Feature Regression implementation.

This module contains the FullDatasetMultiFeatureRegression class which uses
ALL plans in the dataset instead of just frontier plans to capture market-wide
pricing patterns with careful outlier handling and multicollinearity detection.
"""
...
# Feature set definitions (imported from main module)
FEATURE_SETS = {
    'basic': [
